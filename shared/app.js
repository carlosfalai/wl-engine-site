...
(function (global) {
  ...
  var DICT = {
    fr: {
      ...
      panier_step2: 'Indiquez votre budget, votre ménage, vos allergies et votre régime. Tout ce qui contient ou peut contenir vos allergènes est écarté avant même le choix; vérifiez toujours l’étiquette.',
    ...
    en: {
      ...
      panier_step2: 'Enter your budget, household, allergies and diet. Anything that contains or may contain your allergens is set aside before the choice is made; always check the label.',
    ...
    es: {
      ...
      panier_step2: 'Indica tu presupuesto, tu hogar, tus alergias y tu dieta. Todo lo que contiene o puede contener tus alérgenos se aparta antes de elegir; revisa siempre la etiqueta.',
